...
-- Project Supabase: [GANTI DENGAN PROJECT REF KAMU]
-- ============================================
...
-- ============================================
-- SEED DATA — AKUN BARU (BUKAN MILIK TEMANMU)
-- ============================================

-- ── USERS (password default: "123" untuk semua) ──
INSERT INTO users (id, name, email, password, role, created_at, is_active) VALUES
  ('a0000000-0000-0000-0000-000000000001', 'Budi Santoso',         'budi@email.com',       '123', 'user',    '2026-07-06T00:00:00+00:00', TRUE),
  ('a0000000-0000-0000-0000-000000000002', 'Siti Nurhaliza',       'siti@email.com',       '123', 'user',    '2026-07-06T00:00:00+00:00', TRUE),
  ('a0000000-0000-0000-0000-000000000003', 'Rizky Pratama',        'rizky@email.com',      '123', 'helpdesk','2026-07-06T00:00:00+00:00', TRUE),
  ('a0000000-0000-0000-0000-000000000004', 'Dewi Lestari',         'dewi@email.com',       '123', 'helpdesk','2026-07-06T00:00:00+00:00', TRUE),
  ('a0000000-0000-0000-0000-000000000005', 'Admin IT',             'adminit@email.com',    '123', 'admin',   '2026-07-06T00:00:00+00:00', TRUE)
...
-- Untuk development: disable RSL dulu
